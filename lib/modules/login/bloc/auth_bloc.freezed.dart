...
abstract class _$$AuthSuccessImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({String accessToken, String refreshToken, DateTime expiration});
}
...
class _$AuthSuccessImpl implements AuthSuccess {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, accessToken, refreshToken, expiration);
  ...
  TResult when<TResult extends Object?>({
    ...
    return success(accessToken, refreshToken, expiration);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return success?.call(accessToken, refreshToken, expiration);
  }
...
abstract class AuthSuccess implements AuthState {
  const factory AuthSuccess(
      ...
      required final DateTime expiration}) = _$AuthSuccessImpl;
